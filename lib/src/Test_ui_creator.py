...
def main(page: ft.Page):
    ...
    class Player_hub_search():
        ...
        def delete_player():
            for i in range(len(Player_hub_search.table.rows)):
                Player_hub_search.table.rows.pop()
                page.update()
                time.sleep(.01)
        ...
        def add_player():
            ...
            Player_hub_search.table.rows.append(new_row)
            page.update()


        def player_search_menu():  
            print("Player Search clicked")
            return ft.Container(
                width=page.window_width,
                height=page.window_height,
                margin=10,
                ...
                content=ft.Row([
                    ft.Container(
                        ...
                        content=ft.Row(
                            [
                                ft.Column(
                                    [Player_hub_search.table,
                                    ft.FilledTonalButton(text="Delete players",on_click=lambda e: Player_hub_search.delete_player()),
                                    ft.FilledTonalButton(text="Add player",on_click=lambda e: add_multiple())],
    ...
    def route_change(route):
        ...
        ft.View(
            ...
            [   
                ft.Row ([
                ft.Row(alignment="top_left", spacing=25, controls=[side_menu(),menu_background()],expand=True),
                ft.ElevatedButton("Menu", on_click=lambda _: page.go("/")),
                ],
                expand=True)
            ],
        ...
        if page.route == "/Dashboard":
            page.views.append(
                ft.View(
                    ...
                    [
                        ft.Row ([ 
                        ft.Row(alignment="top_left", spacing=25, controls=[side_menu(),dashboard()],expand=True),
        ...
        if page.route == "/Sim Game":
            page.views.append(
                ft.View(
                    ...
                    [
                        ft.Row ([ 
                        ft.Row(alignment="top_let", spacing=25, controls=[side_menu(),sim_game()],expand=True),
        ...
        if page.route == "/Online PvP":
            page.views.append(
                ft.View(
                    ...
                    [
                        ft.Row ([ 
                        ft.Row(alignment="top_let", spacing=25, controls=[side_menu(),online_pvp()],expand=True),
                        ft.ElevatedButton("Go Home", on_click=lambda _: page.go("/")),
                        ],expand=True)
                    ],
                )
        ...
        if page.route == "/Player Search":
            page.views.append(
                ft.View(
                    ...
                    [
                        ft.Row ([ 
                        ft.Row(alignment="top_let", spacing=25, controls=[side_menu(),Player_hub_search.player_search_menu()],expand=True),
                        ft.ElevatedButton("Go Home", on_click=lambda _: page.go("/")),
                        ],expand=True)
                    ],
                )
        ...
        if page.route == "/MY R.O.C Team":
            page.views.append(
                ft.View(
                    ...
                    [
                        ft.Row ([ 
                        ft.Row(alignment="top_let", spacing=25, controls=[side_menu(),my_roc_team()],expand=True),
                        ft.ElevatedButton("Go Home", on_click=lambda _: page.go("/")),
                        ],expand=True)
                    ],
                )
        ...
        if page.route == "/Settings":
            page.views.append(
                ft.View(
                    ...
                    [
                        ft.Row ([ 
                        ft.Row(alignment="top_let", spacing=25, controls=[side_menu(),settings()],expand=True),
                        ft.ElevatedButton("Go Home", on_click=lambda _: page.go("/")),
                        ],expand=True)
                    ],
                )
